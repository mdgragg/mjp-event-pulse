...
import default_theme from 'eventAssets/michael-test/michael-test.theme';
...
export const EVENT_URL = `michael-test`;
        ...
        <FlexHero>
          ...
          <div>
            <Center>
              <BoxedCounter
                event={main_event}
                prefix={`Join Michael Live In:`}
                styles={{
                  textColor: 'blue',
                }}
              />
            </Center>
            <Button__Primary>Button Here!</Button__Primary>
          </div>
        </FlexHero>
        <BodyWrap>
